// MDIBitmap.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CMDIBitmapApp, CWinApp)
	//{{AFX_MSG_MAP(CMDIBitmapApp)
...
/////////////////////////////////////////////////////////////////////////////
// CMDIBitmapApp construction

CMDIBitmapApp::CMDIBitmapApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CMDIBitmapApp object

CMDIBitmapApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CMDIBitmapApp initialization

BOOL CMDIBitmapApp::InitInstance()
{
...
//	CMultiDocTemplate* pDocTemplate;
	...
	m_scriptTemplate = new CMultiDocTemplate(
		IDR_MDIBITTYPE,
		RUNTIME_CLASS(CMDIBitmapDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CMDIBitmapView));
...
/////////////////////////////////////////////////////////////////////////////
// CMDIBitmapApp message handlers

CProjectDoc*	CMDIBitmapApp::GetCurrentProjDoc( void )
{

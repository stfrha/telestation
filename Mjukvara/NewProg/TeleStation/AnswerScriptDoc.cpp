...
IMPLEMENT_DYNCREATE(CAnswerScriptDoc, CDocument)

BEGIN_MESSAGE_MAP(CAnswerScriptDoc, CDocument)
...
/*
BOOL 	CAnswerScriptDoc::IsDocumentValid( void )
{
...
*/
void CAnswerScriptDoc::InvalidateProjectDoc( void )
{
	m_projectDoc = NULL;
}

...
BEGIN_MESSAGE_MAP(CMainFrame, CMDIFrameWnd)
	...
	ON_WM_CLOSE()
	ON_COMMAND(ID_PROJECT_GENRATE_PROJECT_FILES, OnProjectGenrateProjectFiles)
	ON_UPDATE_COMMAND_UI(ID_PROJECT_GENRATE_PROJECT_FILES, OnUpdateProjectGenrateProjectFiles)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CMainFrame::OnProjectGenrateProjectFiles( void ) 
{
	CTeleStationApp*	myApp = (CTeleStationApp*) AfxGetApp();
	...
	if (curProjDoc) {
		m_fileGenDlg.Create(IDD_FILE_GEN_LOG, NULL);
		curProjDoc->GenerateProjectFiles(&m_fileGenDlg);
		m_fileGenDlg.InsertString("--------------------------------");
		m_fileGenDlg.InsertString("File generation process finished");
		m_fileGenDlg.EnableClose();
	}
}

void CMainFrame::OnUpdateProjectGenrateProjectFiles(CCmdUI* pCmdUI) 
{
	CTeleStationApp*	myApp = (CTeleStationApp*) AfxGetApp();

// CListTestDoc.h : interface of the CPhoneBookDoc class
//
/////////////////////////////////////////////////////////////////////////////
...
class CPhoneBookDoc : public CTSDocument
{
...
public:
	...
	void			GeneratePhoneBook(CFileGenDlg* dlg);
...
protected:
	...
	afx_msg void OnPhonebookEditCategories();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};

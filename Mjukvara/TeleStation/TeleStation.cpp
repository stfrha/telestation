...
BOOL CTeleStationApp::InitInstance()
{
	...
	categoryBranch.LoadBitmap(IDB_SCRIPT_BRANCH);
	playMemo.LoadBitmap(IDB_SCRIPT_PLAY_MEMO);
...
//	TransTypeStrings.SetSize(NUM_TRANS_TYPE);
	...
	TransTypeStrings.Add("Category hit");
	TransTypeStrings.Add("Dummmare kan ingen vara");
...
//	CMultiDocTemplate* pDocTemplate;
	...
	m_phoneBookTemplate = new CMultiDocTemplate(
		IDR_CPHNBKTYPE,
		RUNTIME_CLASS(CPhoneBookDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CPhoneBookView));
	AddDocTemplate(m_phoneBookTemplate);
